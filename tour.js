// Random quotes and colors
let oneQuote = document.getElementById("quote");
let quotesHYD = [
    "Hyderabad’s charm lies in its rich, diverse heritage",
    "A city where art, history, and talent thrive together",
    "Hyderabad’s soul reflects through its culture, history, and talent",
    "A blend of tradition, innovation, and artistic expression",
    "Hyderabad’s history, culture, and talent create unique magic",
    "Hyderabad, where culture, history, and talent shine together",
    "From Charminar to modern tech, Hyderabad embraces all talents",
    "Hyderabad’s legacy of talent and culture stands eternal",
    "Hyderabad’s landmarks tell stories of a royal past",
    "Hyderabad is where old traditions blend with technology",
    "From the Nizams to modernity, Hyderabad’s journey fascinates",
    "Hyderabad’s streets echo stories of ancient grandeur",
    "Hyderabad’s biryani is a culinary delight, unmatched anywhere",
    "Legacy, culture, and innovation converge in Hyderabad’s heart",
    "Biryani and smiles – the Hyderabad way of life",
    "Hyderabad, a city that fills your heart and plate",
    "Hyderabad’s magic? It’s in the smiles and spices",
    "Hyderabad, where history and heart meet with a smile",
    "From Charminar to biryani, Hyderabad steals your heart"
];
let quoteColor = [
    "#474E93", "#213555", "#8D0B41", "#001A6E", "#543A14", "#4B5945", "#F26B0F", "#441752", "#355F2E",
    "#640D5F", "#1C325B", "#1F4529", "#4C1F7A", "#1A1A1D", "#3B1C32", "#FFE31A", "#EC8305", "#A66E38",
    "#D91656", "#4E31AA", "#800000", "#921A40", "#1A3636", "#E4003A", "#000000", "#059212", "#06D001",
    "#FF0000", "#A34343", "#12372A", "#232D3F", "#750E21"
];
...
function performSearch() {
    ...
    const places = {
        ...
        outskirts: {
            "ramoji film city": "ramoji-film-card",
            "statue of equality": "statue_of_equality-card",
            "medak church": "medak-chruch-card"
        },
        restaurants: {
            "barbeque spices": "barbeque-spices-card",
        ...
        software: {
            "wipro": "wipro-card",
            "infosys": "infosys-card",
            "microsoft": "microsoft-card",
            "accenture": "accenture-card",
            "capgemini": "capgemini-card",
            "cognizant": "cognizant-card",
            "amazon": "amazon-card",
            "tcs": "tcs-card"
        }
    };
    ...
    for (const category in places) {
        for (const key in places[category]) {
            if (key.includes(searchQuery)) {
                const cardId = places[category][key];
                const targetCard = document.getElementById(cardId);
                if (targetCard) {
                    targetCard.style.display = "block";
                    targetCard.scrollIntoView({ behavior: "smooth", block: "center" });
                    targetCard.style.backgroundColor = "lightyellow";
                    setTimeout(() => targetCard.style.backgroundColor = "", 3000);
                    found = true;
                }
            }
        }
    ...
    if (!found) alert("No results found! Please try another search.");
...
let placeDetails = {
    ...
    "charminar-card": {
        ...
        About_Place: `<b>CHARMINAR</b>, built in <b>1591 by Muhammad Quli Qutb Shah</b>, is a majestic symbol of Hyderabad's history and culture. Constructed to commemorate the end of a devastating plague and mark the founding of Hyderabad, this architectural marvel stands as a testament to the city's rich heritage. Its name, meaning <b>"FOUR TOWERS"</b>, reflects its symmetrical design with four grand minarets, each rising to 56 meters.<br><br>Blending <b>INDO-ISLAMIC and PERSIAN STYLES</b>, the Charminar is made of limestone and granite, featuring stunning arches and intricate motifs. The western side houses a mosque, adding spiritual significance to its elegance. Surrounded by bustling markets like <b>LAAD BAZAAR</b>, known for bangles and pearls, the Charminar is a vibrant cultural hub. Its timeless beauty, especially when illuminated at night, draws visitors worldwide, making it a treasured landmark and a true representation of Hyderabad's legacy.`
    },
    "mecca-masjid-card": {
        adultTicketPrice: "No entry fee",
        childernTicketPrice: "No entry fee",
...
let outskirtsDetails = {
    "ramoji-film-card": {
        ...
        About_Place: `<b>RAMOJI FILM CITY</b> in <b>HYDERABAD</b> is the world's largest integrated film studio complex. Established in <b>1996</b>, it sprawls across over <b>2,000 acres</b> and houses a diverse range of film production facilities. The complex boasts a variety of SETS replicating various historical and contemporary locations, including ancient Indian kingdoms, European cities, and futuristic landscapes.<br><br>The film city offers a unique blend of <b>ENTERTAINMENT</b> and education. Visitors can explore the various film sets, witness live film shoots, and participate in exciting activities like stunt shows and dance performances. The complex also houses a theme park, a convention center, and a luxury hotel, making it a popular tourist destination.`
    },
    ...
    "jalavihar-card": {
        ...
        About_Place: `<b>JALVIHAR</b> is a popular <b>WATER PARK</b> located in <b>HYDERABAD</b>. It is a great place for <b>FAMILY FUN</b> and <b>ENTERTAINMENT</b>. The park offers a variety of water rides and slides, including thrilling water coasters, lazy rivers, and splash pools.<br><br>The park is well-maintained and offers a clean and hygienic environment. The lush green surroundings and the cool water provide a much-needed respite from the hot Hyderabad climate. Jalvihar is a perfect place to spend a fun-filled day with friends and family.`
    },
    "medak-chruch-card": {
        adultTicketPrice: "No entry fee",
        childernTicketPrice: "No entry fee",
        ...
        About_Place: `The <b>MEDAK CATHEDRAL</b> is a prominent <b>CHRISTIAN PILGRIMAGE</b> site located in <b>MEDAK</b>, a district near <b>HYDERABAD</b>. Built in <b>1914</b>, it is one of the largest churches in Asia. The cathedral's imposing architecture is a blend of <b>GOTHIC</b> and <b>ROMANESQUE</b> styles, with soaring spires, stained glass windows, and intricate stone carvings.<br><br>The cathedral's interior is equally impressive, with high ceilings, ornate altars, and beautiful frescoes. It is a popular destination for both religious pilgrims and tourists. The annual <b>MEDAK CHRISTMAS</b> celebrations are particularly famous, attracting thousands of visitors.`
    },
    ...
    "yadagirigutta-card": {
        ...
        About_Place: `<b>YADAGIRIGUTTA</b> is a prominent <b>HILL TEMPLE TOWN</b> dedicated to <b>LORD VENKATESHWARA</b>. Located in Yadadri Bhuvanagiri district of Telangana, India, it is a significant pilgrimage site for Hindus. The temple complex is spread across a hill, offering panoramic views of the surrounding countryside.<br><br>The main temple, built in the <b>DRAVIDIAN STYLE</b> of architecture, is adorned with intricate carvings and sculptures. The sanctum sanctorum houses the idol of Lord Venkateshwara, which is believed to be <b>SELF-MANIFESTED</b>. The temple complex also includes several other shrines dedicated to various Hindu deities. The annual Brahmotsavam festival, held at the temple, is a major attraction for devotees.`
    },
...
let resdetails = {
    "barbeque-spices-card": {
        ...
        About_Place: `<b>BARBEQUE-SPICES</b>, a renowned restaurant chain, was established in 2010. Renowned for its unforgettable grilling experience, it quickly gained popularity among Hyderabad's residents. With multiple branches across the city, including Gachibowli, Banjara Hills, and Ameerpet, BARBEQUE-SPICES offers a diverse selection of vegetarian and non-vegetarian dishes.<br><br>The restaurant's signature live grills allow diners to savor freshly cooked delicacies. From succulent kebabs and grilled seafood to flavorful vegetables, the menu caters to every palate. The average cost of a buffet meal ranges from <b>INR 600 to INR 800</b>, making it an <b>affordable</b> dining option. Barbeque-Spices is highly regarded for its exceptional food quality and lively ambiance, making it a preferred choice for celebrations and casual outings.`
    },
    "bawarchi-card": {
        ...
        About_Place: `<b>BAWARCHI</b>, a legendary name in Hyderabad's culinary scene, has been serving authentic Hyderabadi cuisine for over three decades. Established in <b>1987</b>, the restaurant has gained a loyal following for its inimitable flavors and unparalleled quality.<br><br><b>BAWARCHI</b> offers a diverse menu featuring classic Hyderabadi dishes like <b>Biryani, Haleem</b>, and <b>Qubani Ka Meetha</b>. The restaurant boasts multiple branches across Hyderabad, ensuring accessibility for food enthusiasts. The average cost of a meal at BAWARCHI is moderate, making it an affordable option for a delightful dining experience. The restaurant's focus on authentic flavors and generous portions has consistently garnered praise from patrons.`
    },
    "paradise-card": {
        ...
        About_Place: `The <b>PARADISE RESTAURANT</b> is a renowned dining destination in <b>HYDERABAD</b>, famous for its delectable Biryani and other South Indian delicacies. Established in <b>1953</b>, it has become a <b>CULINARY INSTITUTION</b>, attracting both locals and tourists alike.<br><br>The restaurant's ambiance is a blend of traditional and modern, offering a comfortable and inviting dining experience. The menu features a wide array of dishes, including signature Biryani varieties like Hyderabadi <b>Biryani</b> and <b>Dum Biryani</b>, along with a selection of South Indian specialties such as <b>Dosas, Idlis</b>, and <b>Vadas</b>. The average price per person is around <b>₹500-₹800</b>.`
    },
    "platform 65-card": {
    ...
    "swagath-card": {
        ...
        About_Place: `<b>SWAGATH RESTAURANT</b> was established in 1990, a pioneer in authentic Andhra cuisine. With a focus on traditional recipes and fresh ingredients, Swagath has built a loyal following. Their branches are strategically located across Hyderabad, ensuring accessibility for diners.<br><br>The average cost per person at Swagath Restaurant ranges from <b>INR 400 to INR 800</b>, making it an <b>affordable</b> option for a fine-dining experience. The food at Swagath is renowned for its authenticity and bold flavors, reflecting the rich culinary heritage of Andhra Pradesh. Their most famous dish is undoubtedly the "<b>GONGURA MUTTON</b>", a spicy and tangy mutton curry made with the gongura leaf.`
    }
};

let softwareCompanyDetails = {
    "wipro-card": {
        address: "203, 115/1, ISB Rd, Financial District, Gachibowli, Nanakaramguda, Telangana 500032, India",
        aboutUs: "Wipro's Nanakramguda Campus in Hyderabad was established in 2010. It is located in the Financial District on ISB Road. The campus operates 24/7, offering continuous services. It is known for its modern architecture and pleasant work environment.",
        services: "Wipro provides IT services, digital transformation, and business process outsourcing (BPO) solutions. Their services include cloud computing, cybersecurity, AI, and industry-specific consulting to help businesses enhance efficiency and innovation."
    },
    "infosys-card": {
        address: "Plot No. 44, Survey No. 64, Hitech City, Madhapur, Hyderabad, Telangana 500081, India",
        aboutUs: "Infosys Hyderabad SEZ Campus is one of the largest Infosys facilities. Established in 2008, it serves as a major hub for innovation and client solutions.",
        services: "Infosys provides consulting, IT services, and outsourcing. Their offerings include digital transformation, AI solutions, cloud computing, and business process management."
    },
    "microsoft-card": {
        address: "Gachibowli, Hyderabad, Telangana 500032, India",
        aboutUs: "Microsoft India Development Center (IDC) in Hyderabad, established in 1998, is one of the largest Microsoft campuses outside the USA, focusing on advanced R&D and product innovation.",
        services: "Microsoft provides software development, cloud computing, AI research, cybersecurity, and enterprise solutions for businesses and consumers."
    },
    "accenture-card": {
        address: "Survey No. 64, Hitech City, Madhapur, Hyderabad, Telangana 500081, India",
        aboutUs: "Accenture's Hyderabad office in Hitech City focuses on digital transformation and innovative technology solutions.",
        services: "Accenture offers consulting, technology services, and outsourcing, including cloud services, AI, cybersecurity, and industry-specific solutions."
    },
    "capgemini-card": {
        address: "Gachibowli, Hyderabad, Telangana 500032, India",
        aboutUs: "Capgemini's Hyderabad campus is a hub for global business services and technology innovation.",
        services: "Capgemini provides IT consulting, engineering services, cloud solutions, and digital transformation."
    },
    "cognizant-card": {
        address: "Gachibowli, Hyderabad, Telangana 500032, India",
        aboutUs: "Cognizant's Hyderabad office focuses on IT services and digital innovation.",
        services: "Cognizant provides IT services, digital strategy, consulting, and business process outsourcing."
    },
    "amazon-card": {
        address: "Financial District, Gachibowli, Hyderabad, Telangana 500032, India",
        aboutUs: "Amazon's Hyderabad campus is a key location for research, customer support, and innovation.",
        services: "Amazon provides e-commerce solutions, AWS cloud services, AI research, and customer support."
    },
    "tcs-card": {
        address: "Kohinoor Park, Hitech City, Madhapur, Hyderabad, Telangana 500081, India",
        aboutUs: "TCS Hyderabad is a major IT and business solutions hub, supporting global clients with advanced technology.",
        services: "TCS provides IT services, consulting, business solutions, and digital transformation."
    }
};

// Function for guest login (used by onclick)
function handleGuestLogin(event) {
    ...
    try {
        ...
        window.isLoggedIn = true; // Fallback for when localStorage is disabled
    }
    contentContainer.style.display = "block";
    document.body.style.overflow = "auto";
}

// Login and Popup Logic
document.addEventListener("DOMContentLoaded", () => {
    ...
    const err_block = document.getElementById("Error_popup");
    const Err_icon = document.getElementById("ErrorIcon");
    const Msg = document.getElementById("Message");
    const ErrDescrip = document.getElementById("errorDesc");
    ...
    try {
        ...
        console.error("localStorage is not available:", e);
        loggedIn = window.isLoggedIn ? "true" : "false";
    }
        ...
        signUpForm.addEventListener("submit", (event) => {
            ...
            if (valid) {
                try {
                    ...
                    console.error("localStorage is not available:", e);
                    window.mailVerify = mail;
                    window.pswdVerify = pswd;
                }
                err_block.style.display = "block";
    ...
    if (loginForm) {
        loginForm.addEventListener("submit", (event) => {
            event.preventDefault();
            let savedMail, savedPswd;
            try {
                savedMail = localStorage.getItem("mailVerify");
                savedPswd = localStorage.getItem("pswdVerify");
            } catch (e) {
                console.error("localStorage is not available:", e);
                savedMail = window.mailVerify;
                savedPswd = window.pswdVerify;
            }
    ...
    // Popup functionality
    const displayPopup = (details, mappings) => {
        let loggedIn;
        try {
            loggedIn = localStorage.getItem("loggedIn");
        } catch (e) {
        ...
        if (loggedIn !== "true") {
            alert("Please log in or sign up to access the content.");
            loginFormContainer.style.display = "block";
            return;
        }

        placeName.textContent = card.querySelector(".placeText").textContent;
        popUpImg.src = card.querySelector(".placePhoto").src;
        mappings.forEach(({ header, content, selector }) => {
            if (header) document.querySelector(selector.header).textContent = header;
            document.querySelector(selector.body).textContent = content;
        });
        googleMap.src = details.map || details.MapLink || "";
        popUp.classList.remove("hidden");
        document.body.classList.add("blur-background");
        document.body.style.overflow = "hidden";
        ["hydContent", "carouselExampleIndicators1", "carouselExampleIndicators2", "carouselExampleIndicators3", "carouselExampleIndicators4"].forEach(id => {
        ...
        currentCard.addEventListener("click", function () {
            ...
            if (placeDetails[cardId]) {
                ...
                displayPopup(details, [
                    { content: `Adult: ${details.adultTicketPrice},\nChild: ${details.childernTicketPrice},\nForeigner: ${details.ForeignerTicketPrice}`, selector: { body: "#flush-collapseOne .accordion-body" } },
                    { content: details.foodPrice, selector: { body: "#flush-collapseTwo .accordion-body" } },
                    { content: details.timings, selector: { body: "#flush-collapseThree .accordion-body" } }
                ]);
            } else if (outskirtsDetails[cardId]) {
                details = outskirtsDetails[cardId];
                displayPopup(details, [
                    { content: `Adult: ${details.adultTicketPrice},\nChild: ${details.childernTicketPrice},\nForeigner: ${details.ForeignerTicketPrice}`, selector: { body: "#flush-collapseOne .accordion-body" } },
                    { content: details.foodPrice, selector: { body: "#flush-collapseTwo .accordion-body" } },
                    { content: details.timings, selector: { body: "#flush-collapseThree .accordion-body" } }
                ...
                displayPopup(details, [
                    { header: "Average Food Price", content: details.avgprice, selector: { header: "#Acc_TextOne", body: "#flush-collapseOne .accordion-body" } },
                    { header: "Rating", content: details.rating, selector: { header: "#Acc_TextTwo", body: "#flush-collapseTwo .accordion-body" } },
                    { header: "Timings", content: details.timing, selector: { header: "#Acc_TextThree", body: "#flush-collapseThree .accordion-body" } }
                ]);
            } else if (softwareCompanyDetails[cardId]) {
                details = softwareCompanyDetails[cardId];
                displayPopup(details, [
                    { header: "Company Details", content: details.aboutUs, selector: { header: "#Acc_TextOne", body: "#flush-collapseOne .accordion-body" } },
                    { header: "Location", content: details.address, selector: { header: "#Acc_TextTwo", body: "#flush-collapseTwo .accordion-body" } },
                    { header: "Services", content: details.services, selector: { header: "#Acc_TextThree", body: "#flush-collapseThree .accordion-body" } }
                ]);
            }
        });
    });

    // Image click for extra info
    popUpImg.addEventListener("click", () => {
        ...
        about_place.innerHTML = details.About_Place || "No information available for this place";
